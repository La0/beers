...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_product', (
            ...
            ('brand', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ...
        db.create_table('products_productprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('products', ['ProductPrice'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('products_productprice')

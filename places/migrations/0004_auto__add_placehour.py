...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaceHour'
        db.create_table('places_placehour', (
            ...
            ('happy_hour', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('places', ['PlaceHour'])


    def backwards(self, orm):
        # Deleting model 'PlaceHour'
        db.delete_table('places_placehour')

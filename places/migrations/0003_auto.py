...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subways on 'Place'
        db.create_table('places_place_subways', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['places.place'], null=False)),
            ('subwaystation', models.ForeignKey(orm['geo.subwaystation'], null=False))
        ))
        db.create_unique('places_place_subways', ['place_id', 'subwaystation_id'])


    def backwards(self, orm):
        # Removing M2M table for field subways on 'Place'
        db.delete_table('places_place_subways')
    ...
    models = {
        ...
        'places.place': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'subways': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['geo.SubwayStation']", 'symmetrical': 'False'}),

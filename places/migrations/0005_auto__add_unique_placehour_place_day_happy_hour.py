...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PlaceHour', fields ['place', 'day', 'happy_hour']
        db.create_unique('places_placehour', ['place_id', 'day', 'happy_hour'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlaceHour', fields ['place', 'day', 'happy_hour']
        db.delete_unique('places_placehour', ['place_id', 'day', 'happy_hour'])

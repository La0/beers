...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.instagram_id'
        db.add_column('places_place', 'instagram_id',
                      self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.instagram_id'
        db.delete_column('places_place', 'instagram_id')
    ...
    models = {
        ...
        'places.place': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['importer.PlaceCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'geojson': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instagram_id': ('django.db.models.fields.CharField', [], {'max_length': '24', 'null': 'True', 'blank': 'True'}),

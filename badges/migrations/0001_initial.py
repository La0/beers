...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlaceBadge'
        db.create_table('badges_placebadge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('badges', ['PlaceBadge'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PlaceBadge'
        db.delete_table('badges_placebadge')
